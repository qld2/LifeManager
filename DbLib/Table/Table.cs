...
{
    public interface ITaable<out TableSchema> : IDisposable
    ...
    public class Taable<TableSchema> : ITaable<TableSchema>
        where TableSchema : ITableSchema
    {
        public string Name { get; }
        ...
        public void Refresh(Db db)
        {
            ...
            IEnumerable<TableSchema> response = _connection.Query<TableSchema>(SQLQuery).ToList();
